...
async def convert(self, gen: SomeGen) -> SomeGen:
    return gen
```
Он принимает на вход нужный генератор и возвращает его обратно.
